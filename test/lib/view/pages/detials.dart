                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                                ...
                                gradient: Provider.of<ProductProivder>(context,
                                        ...
                                        .isFavourite
                                    ? LinearGradient(colors: [
                                        Color.fromARGB(221, 223, 147, 48),
                                        Color.fromARGB(170, 59, 201, 23),
                                      ])
                                    : LinearGradient(colors: [
                                        Color.fromARGB(221, 28, 179, 179),
                                        Color.fromARGB(170, 158, 14, 14),
                                      ]),
                                // color: widget.task.isComplete?Colors.blue:Colors.red,
                                borderRadius: BorderRadius.circular(10)),
                            child: Text(
                              '  Price is: ${Provider.of<ProductProivder>(context, listen: false).Allproducts[index].price} \$ ',
                              style: TextStyle(
                                fontSize: 20,
                              ),
                            ),
