  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: ClipRRect(
        ...
        child: Align(
          alignment: Alignment.topRight,
          child: IconButton(padding: EdgeInsets.symmetric(horizontal: 5), onPressed: (){
            widget.newsModel.isFavourite = ! widget.newsModel.isFavourite;
            setState(() {
              
            });
          }, icon: Icon(Icons.favorite,size: 50,color:widget.newsModel.isFavourite?Colors.red:Colors.white),
        )),
      )],
        ),
      ),
